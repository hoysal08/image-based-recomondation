        ...
        for web_link in list_of_url:
            ...
            for div in mydiv:
                ...
                try:
                    ...
                    print("trying to create row")
                    new_row = [{'id': counter, 'brand': brand_ls, 'title': title_ls, 'sold_price': current_price_ls, 'actual_price': actual_price_ls, 'url': url_ls, 'img': img_ls}]
                    print(new_row)
